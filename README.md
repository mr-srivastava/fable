...
**Specimen** is a JSON inspection workbench: create or edit payloads, infer lightweight contract metadata, annotate fields, save to the cloud, and share each specimen via a link. Built with React, TanStack Router, Convex, and Tailwind.
